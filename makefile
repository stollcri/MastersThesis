...
test:
	...
	# ./bin/sc -b 0 -c 0 -d 7 -e 0 ./tst/RightsOfManB-008degree.png ./tst/out_ROMB-008.png
	...
	# time ./bin/sc -b 0 -c 0 -d 3 -e 0 ./tst/Broadway_tower_edit.png ./tst/out_Broadway-4.png
	...
	time ./bin/sc -b 0 -c 3 -d 0 -e 1 -g 0 ./tst/Fig2a.png ./tst/Fig2a-out.png
	time ./bin/sc -b 0 -c 3 -d 0 -e 1 -g 0 ./tst/Fig2b.png ./tst/Fig2b-out.png
