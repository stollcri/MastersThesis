...
test:
	...
	./bin/sc -b 0 -c 0 -d 5 -e 9 ./tst/Broadway_tower_edit_small.png ./tst/out-00.png
	./bin/sc -b 0 -c 0 -d 5 -e 9 ./tst/Fig2a.png ./tst/out-01.png
	./bin/sc -b 0 -c 0 -d 5 -e 9 ./tst/Fig2b.png ./tst/out-02.png
