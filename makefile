...
test:
	...
	./bin/sc -b 9 -c 0 -d c -e 7 ./tst/Broadway_tower_edit_small.png ./tst/out-00.png
	./bin/sc -b 9 -c 0 -d c -e 7 ./tst/Fig2a.png ./tst/out-01.png
	./bin/sc -b 9 -c 0 -d c -e 7 ./tst/Fig2b.png ./tst/out-02.png
