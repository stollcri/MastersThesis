...
int getPixelEnergySimple(struct pixel *imageVector, int imageWidth, int imageHeight, int currentPixel, int gradientSize)
{
...
int getPixelEnergySobel(int *imageVector, int imageWidth, int imageHeight, int imageDepth, int currentPixel)
{
	int pixelDepth = imageDepth;
	...
	// return max((int)(sqrt((sobelX * sobelX) + (sobelY * sobelY))/5.679), 0);
...
int getPixelEnergyLaplacian(struct pixel *imageVector, int imageWidth, int imageHeight, int currentPixel)
{
	int pixelDepth = 1;
	int imageByteWidth = imageWidth * pixelDepth;
	int currentCol = currentPixel % imageByteWidth;
...
int getPixelGaussian(struct pixel *imageVector, int imageWidth, int imageHeight, int pixelDepth, int currentPixel, int sigma)
{
	int imageByteWidth = imageWidth * pixelDepth;
	int points[25];
...
int getPixelEnergyDoG(int gaussianValue1, int gaussianValue2)
{
...
int getPixelEnergyStoll(struct pixel *imageVector, int imageWidth, int imageHeight, int pixelDepth, int currentPixel)
{
	int imageByteWidth = imageWidth * pixelDepth;
	int points[25];
	double pointValues[25];
